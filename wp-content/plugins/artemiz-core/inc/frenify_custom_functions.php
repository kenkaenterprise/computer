...
$attchments_options = array(
	'image_video_url' => array(
        'label'       => __( 'External Video Url', 'artemiz' ),
        'input'       => 'text',
        'helps'       => __( 'Url from Youtube or Vimeo', 'artemiz' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
    ),
);

class Artemiz_Custom_Media_Fields {
...
$cmf = new Artemiz_Custom_Media_Fields( $attchments_options );
